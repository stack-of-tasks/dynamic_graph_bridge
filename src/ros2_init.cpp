...
namespace dynamicgraph {
  ...
  public:
        ...
        //      ,interpreter_()
    {
      ...
      srv_run_cmd_ =
        create_service<dynamic_graph_bridge_msgs::srv::RunCommand>
        ( "run_command",
      ...
      srv_run_py_file_ =
        create_service<dynamic_graph_bridge_msgs::srv::RunPythonFile>
        ( "run_script",
          std::bind(
  ...
  rclcpp::Node::SharedPtr RosContext::rosInit()
  {
    if (nodeHandle)
      return nodeHandle;
    ...
    nodeHandle =
      std::make_shared<DualThreadedNode>();

    mtExecutor = std::make_shared<rclcpp::executors::MultiThreadedExecutor>();
    mtExecutor->add_node(nodeHandle);
    return nodeHandle;
  }

  rclcpp::executors::MultiThreadedExecutor::SharedPtr RosContext::rosInitGetExecutor()
  {
    if (mtExecutor)
